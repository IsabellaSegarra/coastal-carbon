...
This repository is for analyzing data from the Coastal Carbon Network as part of the EDS-222 final project. It investigates the dynamics of soil organic matter on fraction carbon in coastal ecosystems. 
...
├── CCN_data
│   ├── _README.txt
│   ├── CCN_bibliography.bib
│   ├── CCN_bibliography.csv
│   ├── CCN_bibliography.txt
│   ├── CCN_cores.csv
│   ├── CCN_data_dictionary.csv
│   ├── CCN_depthseries.csv
│   ├── CCN_impacts.csv
│   ├── CCN_methods.csv
│   ├── CCN_sites.csv
│   └── CCN_species.csv
├── coastal-carbon.Rproj
